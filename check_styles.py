...
parser.add_argument('--extensions', nargs='+', type=str, default=[
                    'png', 'jpeg', 'jpg'], help='List of image extensions to scan style and content directory for (case sensitive), default: png, jpeg, jpg')
...
def main():
    ...
    assert len(
        dataset) > 0, 'No images with specified extensions found in content directory' + content_dir
    ...
    assert len(
        styles) > 0, 'No images with specified extensions found in style directory' + style_dir
        ...
        for content_path in content_paths:
            try:
                ...
                for style_path in styles:
                    ...
                    sp = str(style_path)[str(style_path).rindex('/')+1:]
                    c = d[sp]
                ...
                print('Skipping stylization of %s due to an error' %
                      (content_path))
